...
**Versão:** 1.2  
**Data:** 2026-07-11  
**Sprint:** 05–06 — baseline térreo (hotfix colisão móveis)  
...
- **Hotfix:** colisão móveis grandes; depósito selado (alcoves + moldura + fundo 14 m)

**Depósito (selado):**
- `Wall_Deposit_Back/Left/Right`
- `Wall_Deposit_AlcoveWest/East`
- `Wall_Deposit_DoorFrame_Left/Right`, `Wall_Deposit_DoorHeader`
- `Door_Deposit_Blocked`
...
| _(Sprint 06 hotfix)_ | fix: add furniture collisions and seal deposit blockout |
