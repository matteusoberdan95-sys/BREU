...
/// <summary>
/// Sprint 08 stair lab — spawn, reset (F9), HUD welcome message.
/// </summary>
public partial class StairMovementLabController : Node3D
{
    ...
    {
        ShowHudMessage(
            "StairMovementLab — suba e desça a escada. F9: reset | F10/F11: debug");
    }
