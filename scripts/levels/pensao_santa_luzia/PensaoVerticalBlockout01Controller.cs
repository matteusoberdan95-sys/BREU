...
/// <summary>
/// Sprint 10 vertical slice — spawn, F9 reset, welcome HUD message.
/// </summary>
public partial class PensaoVerticalBlockout01Controller : Node3D
{
    ...
    private void ShowWelcomeMessage()
    {
        HUDController.FindActive(GetTree())?.ShowMessage(
            "Pensao Santa Luzia — térreo + segundo andar blockout. Siga a trilha.",
            4.5f);
    }
}
