...
/// <summary>
/// Simple stamina pool for sprint (and future combat). Emits StaminaChanged for HUD Sprint 03.
/// </summary>
public partial class PlayerStamina : Node
{
    ...
    [Export] public float RegenPerSecond { get; set; } = 14.0f;
    [Export] public float RegenDelaySeconds { get; set; } = 0.75f;
